...
const validRegistersTI = {
    "ACC": "Accumulator",
    "PC": "Program Counter",
    "IN1": "Indexregister 1",
    "IN2": "Indexregister 2"
};
const validRegistersOS = {
    ...validRegistersTI,
    "SP": "Stack Pointer",
...
class LanguageConfig {
    osMode = false;
    setOsMode(osMode) { this.osMode = osMode; }
    getDocumentation() {
        if (this.osMode) {
...
//# sourceMappingURL=language_config.js.map