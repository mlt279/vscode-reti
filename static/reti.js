...
export function randomReti(length, bitSizeImmediate = 24) {
...
export function randomInstruction(bitSizeImmediate = 24) {
...
function randomComputeInstruction(bitSizeImmediate) {
...
function randomLoadInstruction(bitSizeImmediate) {
...
function randomStoreInstruction(bitSizeImmediate) {
    let mode = ranFromRangeInt(0b00, 0b11);
    let source = 0;
    let destination = 0;
    let immediate = ranFromRangeInt(0, generateBitMask(bitSizeImmediate)) & generateBitMask(24);
...
function randomJumpInstruction(bitSizeImmediate) {
