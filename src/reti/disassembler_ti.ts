...
export function decodeInstruction(instruction: number): [string, [string, number, string][]] {
...
function decodeComputeInstruction(instruction: number): [string, [string, number, string][]] {
    let explanationList: [string, number, string][] = [];
...
function decodeLoadInstruction(instruction: number): [string, [string, number, string][]] {
    let explanationList: [string, number, string][] = [];
...
function decodeStoreInstruction(instruction: number): [string, [string, number, string][]] {
    let explanationList: [string, number, string][] = [];
...
function decodeJumpInstruction(instruction: number): [string, [string, number, string][]] {
    let explanationList: [string, number, string][] = [];
